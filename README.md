...
Клиент-серверное приложение для обмена сообщениями в реальном времени, разработанное на платформе .NET 8.0 с использованием UI-фреймворка Avalonia.

![UML-схема](docs/images/photo_interface.jpg)
## Структура решения
...
* **SDK:** [.NET 8.0 SDK](https://dotnet.microsoft.com/download/dotnet/8.0) или новее.
* **Язык:** C# 12.0.
* **UI-фреймворк:** Avalonia 11.3.12.
* **Поддерживаемые ОС:**
    * **Windows:** 10 и выше (x64/ARM64).
    * **macOS:** 10.13 и выше.
    * **Linux:** Большинство дистрибутивов (требуется наличие библиотек X11 или Wayland).
...
1.Клонирование репозитория
 ```bash
git clone https://github.com/jota2069/ChatApp.git
 ```
